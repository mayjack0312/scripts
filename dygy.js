/*
 ...
 [task_local]
 #抖抖果园
 15 8,10,12,18,20 * * * url/dygy.js, tag=抖音果园, enabled=true
 [rewrite_local]
 https://minigame.zijieapi.com/ttgame/game_orchard_ecom/polling_info url script-request-header url/dygy.js
 [MITM]
